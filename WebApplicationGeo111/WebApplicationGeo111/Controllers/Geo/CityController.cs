    ...
    public class CityController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            var applicationDbContext 
                = _context.Cities.Include(c => c.Area);
        ...
        {
            ViewData["Areas"] = new SelectList(_context.Areas, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,AreaId")] CityModel cityModel)
        {
           ...
           // ViewData["AreaId"] = new SelectList(_context.Areas, "Id", "Id", cityModel.AreaId);
            return View(cityModel);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,AreaId")] CityModel cityModel)
        {
            if (id != cityModel.Id)
            {
                return NotFound();
